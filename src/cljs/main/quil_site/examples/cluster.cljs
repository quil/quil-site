...
(defn gravacc-at-pos [pos n-bodies]
...
(defn setup []
  ...
  (reset! store {:bodies   init-bodies
...
(quil-site.main/register-example! "cluster" "Marco Fink" run-sketch :interactive? false :white-play-button? true) ;DELETE
